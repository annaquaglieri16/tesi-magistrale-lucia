...
##TODO: dividi tutte le motivazioni e fai grafici
...
miglioramento_per_gruppo <- risposte %>% 
  ...
  mutate(N.partecipanti = case_when(ex_pre_si_no == "Si" ~ N.partecipanti/tot_si,
                                    ex_pre_si_no == "No" ~ N.partecipanti/tot_no))
